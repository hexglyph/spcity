...
import { updateGovernedCells } from "@/app/utils/governedCells"
...
export async function claimGovernance(cellId: string, position: Position) {
    ...
    try {
        ...
        const isWithinBounds =
            position.latitude >= cell.coordinates.latRange[0] &&
        ...
        // Update the cell
        await collection.updateOne({ _id: new ObjectId(cellId) }, { $set: { governance: governanceData } })
